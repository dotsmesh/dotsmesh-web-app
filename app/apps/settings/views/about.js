...
async (args, library) => {
    try {
        ...
        x.add(x.makeText('Dots Mesh is and open social platform. Visit <a onclick="x.openURL(\'https://about.dotsmesh.com/\');">about.dotsmesh.com</a> for all the details.', false, true));
